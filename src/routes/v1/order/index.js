...
import { createOrder, getAllOrder, updateOrder, getOrderById, getOrderByCustomerId, getOrderByTeknisiId, updateOrderByCustomer, downloadFile } from '../../../controller/orderController.js';
...
orderRouter.get('/list', downloadFile, authenticationMiddleware, authorizationAdmin, getAllOrder)
